...
- ✅ **Добавлена информативная подсказка при F2** (назначение директивного графика)
  - При первом установке базового плана: "Вы назначили базовый план. Нажмите F3 для отображения в диаграмме Ганта" (3 секунды)
  - При перезаписи существующего плана: "Базовый план перезаписан. Нажмите F3 для отображения в диаграмме Ганта" (3 секунды)
  - Помогает пользователям понять следующие шаги
