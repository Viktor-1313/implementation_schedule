...
- **Анимация воды и светлячки** — такие же эффекты, как на странице авторизации:
  - Интерактивный canvas с волнами от движения курсора
  - 12 светлячков, которые убегают от курсора и отскакивают от краёв экрана
  - На мобильных устройствах: волны создаются при тапе и движении зажатым пальцем
- **Приветствие**:
...
- ✅ **Мобильная оптимизация**:
  ...
  - Модальные окна позиционируются рядом с кнопками на мобильных устройствах
  - Интерактивные эффекты (волны, светлячки) работают от тапа и движения пальца
