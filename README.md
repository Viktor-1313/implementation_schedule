...
- Публичный URL для авторизации: `https://ваш-домен.com/auth.html`
- Публичный URL для выбора компаний: `https://ваш-домен.com/companies.html`
- Публичный URL для графика: `https://ваш-домен.com/implementation_schedule.html?company=xxx`
- Ссылка для просмотра: `https://ваш-домен.com/auth.html?company=xxx`
